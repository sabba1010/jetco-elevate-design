...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "JetCo Home & Commercial Services — Six trusted trades, one team." },
      { property: "og:description", content: "Pest control, HVAC, roofing, windows, flooring and handyman services from one trusted, local team. Licensed, insured and guaranteed." },
